...
public class webcam2 extends javax.swing.JDialog{
    public webcam2(java.awt.Frame parent, boolean modal){
        ...
        try{
            ...
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-IAE",ñ.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-28",k.fillInStackTrace());
        }catch(FileNotFoundException d){
            JOptionPane.showMessageDialog(null,"Error:\n"+d.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+d.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-1IO",d.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-2IO",s.fillInStackTrace());
        }
