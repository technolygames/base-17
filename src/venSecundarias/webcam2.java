...
import static venPrimarias.formulario2.picLabel;
...
public class webcam2 extends javax.swing.JDialog{
    public webcam2(java.awt.Frame parent, boolean modal){
        super(parent, modal);
        initComponents();
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-CNFE",e.fillInStackTrace());
        }catch(InstantiationException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error IE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IE: "+x.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-IE",x.fillInStackTrace());
        }catch(IllegalAccessException n){
            JOptionPane.showMessageDialog(null,"Error:\n"+n.getMessage(),"Error IAE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IAE: "+n.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-IAE",n.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+y.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-28",y.fillInStackTrace());
        }catch(NullPointerException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 0",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 0: "+k.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-0",k.fillInStackTrace());
        }catch(FileNotFoundException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+s.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-1IO",s.fillInStackTrace());
        }catch(IOException d){
            JOptionPane.showMessageDialog(null,"Error:\n"+d.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+d.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'webcam2()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"webcam2-2IO",d.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().logStaticSaver("Error 1IO: "+e.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'getIconImage()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"getIconImage-1IO",e.fillInStackTrace());
        }catch(IOException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+x.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'getIconImage()'",Level.WARNING);
            new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"getIconImage-2IO",x.fillInStackTrace());
        }
        return retValue;
    }
    ...
    protected final void botones(){
        ...
        picButton.addActionListener((ae)->{
            try{
                ...
                new logger().logStaticSaver("Error 41: "+e.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'botones(picButton)'",Level.WARNING);
                new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"botones.pic-41",e.fillInStackTrace());
            }catch(IOException x){
                JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 0",JOptionPane.WARNING_MESSAGE);
                new logger().logStaticSaver("Error 0: "+x.getMessage()+".\nOcurrió en la clase '"+webcam2.class.getName()+"', en el método 'botones(picButton)'",Level.WARNING);
                new logger().exceptionLogger(webcam2.class.getName(),Level.WARNING,"botones.pic-0",x.fillInStackTrace());
            }
        });
    }
