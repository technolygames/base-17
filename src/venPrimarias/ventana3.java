...
public class ventana3 extends javax.swing.JFrame{
    public ventana3(){
        ...
        try{
            ...
            new logger().logStaticSaver("Error IAE: "+ñ.getMessage()+" en 'ventana3()'",Level.WARNING);
            new logger().exceptionLogger(ventana3.class.getName(),Level.WARNING,"ventana3-IAE",ñ.fillInStackTrace());
