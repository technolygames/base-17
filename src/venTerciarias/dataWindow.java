...
public class dataWindow extends javax.swing.JDialog{
    public dataWindow(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'dataWindow()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"dataWindow-CNFE",e.fillInStackTrace());
        }catch(InstantiationException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error IE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IE: "+x.getMessage()+" en 'dataWindow()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"dataWindow-IE",x.fillInStackTrace());
        }catch(IllegalAccessException ñ){
            JOptionPane.showMessageDialog(null,"Error:\n"+ñ.getMessage(),"Error IAE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IAE: "+ñ.getMessage()+" en 'dataWindow()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"dataWindow-IAE",ñ.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'dataWindow()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"dataWindow-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'dataWindow()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"dataWindow-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'dataWindow()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"dataWindow-2IO",s.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"getIconImage-1IO",e.fillInStackTrace());
        }catch(IOException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+x.getMessage()+" en 'getIconImage()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"getIconImage-2IO",x.fillInStackTrace());
        }
        return retValue;
    }
    ...
    protected final void datosMostrar(){
        ...
        try{
            ...
            new logger().logStaticSaver("Error 10: "+e.getMessage()+" en 'datosMostrar()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"datosMostrar-10",e.fillInStackTrace());
        }catch(NullPointerException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 0",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 0: "+x.getMessage()+" en 'datosMostrar()'",Level.WARNING);
            new logger().exceptionLogger(dataWindow.class.getName(),Level.WARNING,"datosMostrar-0",x.fillInStackTrace());
        }catch(IOException ñ){
            JOptionPane.showMessageDialog(null,"Error:\n"+ñ.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+ñ.getMessage()+" en 'datosMostrar()'",Level.WARNING);
