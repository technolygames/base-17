...
public class validacionVentana1 extends javax.swing.JDialog{
    ...
    public validacionVentana1(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+".\nOcurrió en la clase '"+validacionVentana1.class.getName()+"', en el método 'validacionVentana1()'",Level.WARNING);
            ...
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-IAE",n.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+y.getMessage()+".\nOcurrió en la clase '"+validacionVentana1.class.getName()+"', en el método 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-28",y.fillInStackTrace());
        }catch(NullPointerException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 0",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 0: "+k.getMessage()+".\nOcurrió en la clase '"+validacionVentana1.class.getName()+"', en el método 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-0",k.fillInStackTrace());
        }catch(FileNotFoundException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+s.getMessage()+".\nOcurrió en la clase '"+validacionVentana1.class.getName()+"', en el método 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-1IO",s.fillInStackTrace());
        }catch(IOException d){
            JOptionPane.showMessageDialog(null,"Error:\n"+d.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+d.getMessage()+".\nOcurrió en la clase '"+validacionVentana1.class.getName()+"', en el método 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-2IO",d.fillInStackTrace());
        }
