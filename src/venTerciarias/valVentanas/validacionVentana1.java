...
public class validacionVentana1 extends javax.swing.JDialog{
    ...
    public validacionVentana1(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-CNFE",e.fillInStackTrace());
        }catch(InstantiationException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error IE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IE: "+x.getMessage()+" en 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-IE",x.fillInStackTrace());
        }catch(IllegalAccessException ñ){
            JOptionPane.showMessageDialog(null,"Error:\n"+ñ.getMessage(),"Error IAE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IAE: "+ñ.getMessage()+" en 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-IAE",ñ.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'validacionVentana1()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"validacionVentana1-2IO",s.fillInStackTrace());
        }
    ...
    protected final void botones(){
        ...
        valButton.addActionListener((ae)->{
            ...
            try{
                if(!jTextField1.getText().equals("")||jPasswordField1.getPassword().equals("")){
                    ...
                    if(rs.next()){
                        if(rs.getString("puesto").equals("Dueño")||rs.getString("puesto").equals("Programador")||rs.getString("puesto").equals("Desarrollador")){
                            ...
                            new logger().logStaticSaver("Error 37: usuario sin privilegios en '"+validacionVentana1.class.getName()+".botones(valButton)'",Level.WARNING);
                        }
                    }
                    ps.close();
                    rs.close();
                    ...
                    new logger().logStaticSaver("Error 18: no se escribió usuario y/o contraseña en '"+validacionVentana1.class.getName()+".botones(valButton)'",Level.WARNING);
                }
                ...
                new logger().exceptionLogger(validacionVentana1.class.getName(),Level.WARNING,"botones.val-9",e.fillInStackTrace());
            }
        });
    }
