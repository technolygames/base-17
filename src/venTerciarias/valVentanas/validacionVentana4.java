...
public class validacionVentana4 extends javax.swing.JDialog{
    public validacionVentana4(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'validacionVentana4()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IE: "+x.getMessage()+" en 'validacionVentana4()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IAE: "+ñ.getMessage()+" en 'validacionVentana4()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana4.class.getName(),Level.WARNING,"validacionVentana4-IAE",ñ.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'validacionVentana4()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana4.class.getName(),Level.WARNING,"validacionVentana4-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'validacionVentana4()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana4.class.getName(),Level.WARNING,"validacionVentana4-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'validacionVentana4()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana4.class.getName(),Level.WARNING,"validacionVentana4-2IO",s.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().exceptionLogger(validacionVentana4.class.getName(),Level.WARNING,"getIconImage-1IO",e.fillInStackTrace());
        }catch(IOException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+x.getMessage()+" en 'getIconImage()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana4.class.getName(),Level.WARNING,"getIconOImage-2IO",x.fillInStackTrace());
        }
        return retValue;
    }
