...
public class validacionVentana8 extends javax.swing.JDialog{
    public validacionVentana8(java.awt.Frame parent, boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'validacionVentana8()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IE: "+x.getMessage()+" en 'validacionVentana8()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IAE: "+n.getMessage()+" en 'validacionVentana8()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'validacionVentana8()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana8.class.getName(),Level.WARNING,"validacionVentana8-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'validacionVentana8()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana8.class.getName(),Level.WARNING,"validacionVentana8-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'validacionVentana8()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana8.class.getName(),Level.WARNING,"validacionVentana8-2IO",s.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().exceptionLogger(validacionVentana8.class.getName(),Level.WARNING,"geticonImage-1IO",e.fillInStackTrace());
        }catch(IOException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+x.getMessage()+" en 'geticonImage()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana8.class.getName(),Level.WARNING,"getIconImage-2IO",x.fillInStackTrace());
        }
        return retValue;
    }
