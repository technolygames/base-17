...
public class validacionVentana5 extends javax.swing.JDialog{
    public validacionVentana5(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'validacionVentana5()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error iE: "+x.getMessage()+" en 'validacionVentana5()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IAE: "+ñ.getMessage()+" en 'validacionVentana5()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana5.class.getName(),Level.WARNING,"validacionVentana5-IAE",ñ.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'validacionVentana5()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana5.class.getName(),Level.WARNING,"validacionVentana5-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'validacionVentana5()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana5.class.getName(),Level.WARNING,"validacionVentana5-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'validacionVentana5()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana5.class.getName(),Level.WARNING,"validacionVentana5-2IO",s.fillInStackTrace());
        }
