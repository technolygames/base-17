...
public class validacionVentana3 extends javax.swing.JDialog{
    public validacionVentana3(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-CNFE",e.fillInStackTrace());
        }catch(InstantiationException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error IE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IE: "+x.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-IE",x.fillInStackTrace());
        }catch(IllegalAccessException n){
            JOptionPane.showMessageDialog(null,"Error:\n"+n.getMessage(),"Error IAE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IAE: "+n.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-IAE",n.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+y.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-28",y.fillInStackTrace());
        }catch(NullPointerException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 0",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 0: "+k.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-0",k.fillInStackTrace());
        }catch(FileNotFoundException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+s.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-1IO",s.fillInStackTrace());
        }catch(IOException d){
            JOptionPane.showMessageDialog(null,"Error:\n"+d.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+d.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-2IO",d.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().logStaticSaver("Error 1IO: "+e.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'geticonImage()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"getIconImage-1IO",e.fillInStackTrace());
        }catch(IOException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+x.getMessage()+".\nOcurrió en la clase '"+validacionVentana3.class.getName()+"', en el método 'getIconImage()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"getIconImage-2IO",x.fillInStackTrace());
        }
        return retValue;
    }
                ...
                if(!jTextField1.getText().equals("")||!jPasswordField1.getPassword().equals("")){
                    ...
                    if(rs.next()){
                        if(rs.getString("puesto").equals("Dueño")||rs.getString("puesto").equals("Programador")||rs.getString("puesto").equals("Desarrollador")){
                            ...
                            new logger().logStaticSaver("Error 37: usuario sin privilegios en '"+validacionVentana3.class.getName()+".botones(valButton)'",Level.WARNING);
                        }
                    }else{
                    ...
                    new logger().logStaticSaver("Error 18: no se escribió usuario y/o contraseña en '"+validacionVentana3.class.getName()+".botones(valButton)'",Level.WARNING);
                }
