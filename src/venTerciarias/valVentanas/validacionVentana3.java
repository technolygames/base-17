...
public class validacionVentana3 extends javax.swing.JDialog{
    public validacionVentana3(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'validacionVentana3()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IE: "+x.getMessage()+" en 'validacionVentana3()'",Level.WARNING);
            ...
            new logger().logStaticSaver("Error IAE: "+ñ.getMessage()+" en 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-IAE",ñ.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'validacionVentana3()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana3.class.getName(),Level.WARNING,"validacionVentana3-2IO",s.fillInStackTrace());
        }
