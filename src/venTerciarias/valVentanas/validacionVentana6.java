...
public class validacionVentana6 extends javax.swing.JDialog{
    public validacionVentana6(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+" en 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-CNFE",e.fillInStackTrace());
        }catch(InstantiationException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error IE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IE: "+x.getMessage()+" en 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-IE",x.fillInStackTrace());
        }catch(IllegalAccessException n){
            JOptionPane.showMessageDialog(null,"Error:\n"+n.getMessage(),"Error IAE",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error IAE: "+n.getMessage()+" en 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-IAE",n.fillInStackTrace());
        }catch(UnsupportedLookAndFeelException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 28",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 28: "+k.getMessage()+" en 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-28",k.fillInStackTrace());
        }catch(FileNotFoundException y){
            JOptionPane.showMessageDialog(null,"Error:\n"+y.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+y.getMessage()+" en 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-1IO",y.fillInStackTrace());
        }catch(IOException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+s.getMessage()+" en 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-2IO",s.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"getIconImage-1IO",e.fillInStackTrace());
        }catch(IOException x){
            JOptionPane.showMessageDialog(null,"Error:\n"+x.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+x.getMessage()+" en 'getIconIMage()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"getIconImage-2IO",x.fillInStackTrace());
        }
        return retValue;
    }
    ...
    protected final void botones(){
        ...
        valButton.addActionListener((ae)->{
            ...
            try{
                ...
                new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"botones.val-9",e.fillInStackTrace());
            }
        });
    }
