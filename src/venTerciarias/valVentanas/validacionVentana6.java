...
public class validacionVentana6 extends javax.swing.JDialog{
    public validacionVentana6(java.awt.Frame parent,boolean modal){
        ...
        try{
            ...
            new logger().logStaticSaver("Error CNFE: "+e.getMessage()+".\nOcurrió en la clase '"+validacionVentana6.class.getName()+"', en el método 'validacionVentana6()'",Level.WARNING);
            ...
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-28",y.fillInStackTrace());
        }catch(NullPointerException k){
            JOptionPane.showMessageDialog(null,"Error:\n"+k.getMessage(),"Error 0",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 0: "+k.getMessage()+".\nOcurrió en la clase '"+validacionVentana6.class.getName()+"', en el método 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-0",k.fillInStackTrace());
        }catch(FileNotFoundException s){
            JOptionPane.showMessageDialog(null,"Error:\n"+s.getMessage(),"Error 1IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 1IO: "+s.getMessage()+".\nOcurrió en la clase '"+validacionVentana6.class.getName()+"', en el método 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-1IO",s.fillInStackTrace());
        }catch(IOException d){
            JOptionPane.showMessageDialog(null,"Error:\n"+d.getMessage(),"Error 2IO",JOptionPane.WARNING_MESSAGE);
            new logger().logStaticSaver("Error 2IO: "+d.getMessage()+".\nOcurrió en la clase '"+validacionVentana6.class.getName()+"', en el método 'validacionVentana6()'",Level.WARNING);
            new logger().exceptionLogger(validacionVentana6.class.getName(),Level.WARNING,"validacionVentana6-2IO",d.fillInStackTrace());
        }
    ...
    public Image getIconImage(){
        ...
        try{
            ...
            new logger().logStaticSaver("Error 1IO: "+e.getMessage()+".\nOcurrió en la clase '"+validacionVentana6.class.getName()+"', en el método 'getIconImage()'",Level.WARNING);
    ...
    protected final void botones(){
        ...
        valButton.addActionListener((ae)->{
            ...
            try{
                if(!jTextField1.getText().equals("")||!jPasswordField1.getPassword().equals("")){
                    ...
                    if(rs.next()){
                        if(rs.getString("puesto").equals("Dueño")||rs.getString("puesto").equals("Programador")||rs.getString("puesto").equals("Desarrollador")){
                            ...
                            new logger().logStaticSaver("Error 37: usuario sin privilegios.\nOcurrió en '"+validacionVentana6.class.getName()+"', en el método 'botones(valButton)'",Level.WARNING);
                        }
                    }else{
                ...
                new logger().logStaticSaver("Error 9: "+e.getMessage()+".\nOcurrió en la clase '"+validacionVentana6.class.getName()+"', en el método 'botones(valButton)'",Level.WARNING);
