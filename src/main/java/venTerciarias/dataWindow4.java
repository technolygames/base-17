...
public class dataWindow4 extends javax.swing.JDialog{
    public dataWindow4(java.awt.Frame parent,boolean modal){
        super(parent,modal);
        initComponents();
        new laf(dataWindow4.class.getName()).LookAndFeel(dataWindow4.this);
    ...
    protected final void botones(){
        ...
        storeImgButton.addActionListener((a)->{
            try{
                ...
                File f=new File(System.getProperty("user.dir")+"/src/main/resources/data/media/dataImage/empleados/perfil/"+(int)(Math.random()*100000)+".jpg");
