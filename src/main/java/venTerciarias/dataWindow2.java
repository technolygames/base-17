...
public class dataWindow2 extends javax.swing.JDialog{
    public dataWindow2(java.awt.Frame parent,boolean modal){
        super(parent, modal);
        initComponents();
        new laf().LookAndFeel(dataWindow2.this,dataWindow2.class.getName(),"dataWindow2");
    ...
    protected final void botones(){
        ...
        storeImgButton.addActionListener((a)->{
            try{
                ...
                File f=new File(System.getProperty("user.dir")+"/src/main/resources/data/media/dataImage/socios/"+(int)(Math.random()*100000)+".jpg");
