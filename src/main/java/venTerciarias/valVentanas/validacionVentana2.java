...
public class validacionVentana2 extends javax.swing.JDialog{
    public validacionVentana2(java.awt.Frame parent,boolean modal){
        super(parent,modal);
        initComponents();
        new guiMediaHandler(validacionVentana2.class.getName()).LookAndFeel(validacionVentana2.this);
    ...
    protected final void botones(){
        ...
        valButton.addActionListener((a)->{
            ...
            try{
                ...
                new logger(Level.SEVERE).exceptionLogger(validacionVentana2.class.getName(),"botones.val-9",e.fillInStackTrace());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        setIconImage(new guiMediaHandler(validacionVentana2.class.getName()).getIconImage());
