...
public class validacionVentana7 extends javax.swing.JDialog{
    public validacionVentana7(java.awt.Frame parent,boolean modal){
        super(parent, modal);
        initComponents();
        new guiMediaHandler(validacionVentana7.class.getName()).LookAndFeel(validacionVentana7.this);
    ...
    protected final void botones(){
        ...
        valButton.addActionListener((a)->{
            ...
            try{
                ...
                new logger(Level.SEVERE).exceptionLogger(validacionVentana7.class.getName(),"botones.val-9",e.fillInStackTrace());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        setIconImage(new guiMediaHandler(validacionVentana7.class.getName()).getIconImage());
