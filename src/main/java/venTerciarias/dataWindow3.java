...
public class dataWindow3 extends javax.swing.JDialog{
    public dataWindow3(java.awt.Frame parent,boolean modal){
        super(parent, modal);
        initComponents();
        new laf(dataWindow3.class.getName()).LookAndFeel(dataWindow3.this);
    ...
    protected final void datosMostrar(){
        ...
        try{
            ps=new datos().getConnection().prepareStatement("select * from proveedor where codigo_prov="+etiqueta+";");
            rs=ps.executeQuery();
            if(rs.next()){
    ...
    protected final void botones(){
        ...
        storeImgButton.addActionListener((a)->{
            try{
                ...
                File f=new File(System.getProperty("user.dir")+"/src/main/resources/data/media/dataImage/proveedor/"+(int)(Math.random()*100000)+".jpg");
                ...
                new logger().exceptionLogger(dataWindow3.class.getName(),Level.WARNING,"botones.storeImg-14",e.fillInStackTrace());
                ...
                new logger().exceptionLogger(dataWindow3.class.getName(),Level.WARNING,"botones.storeImg-0",y.fillInStackTrace());
            }
        });
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(genLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE))
