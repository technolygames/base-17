...
public class escritorJSON{
    ...
    public void writeDataWorkerJson(int codigoEmpleado){
        try{
            ...
            rs=ps.executeQuery();
            while(rs.next()){
                new File(System.getProperty("user.dir")+"/src/main/resources/data/databackup/Empleados/"+rs.getString("nombre_emp")+"-"+rs.getInt("codigo_emp")).mkdir();
                jsonw=new JsonWriter(new OutputStreamWriter(new FileOutputStream(System.getProperty("user.dir")+"/src/main/resources/data/databackup/Empleados/"+rs.getString("nombre_emp")+"-"+rs.getInt("codigo_emp")+"/"+rs.getString("nombre_emp")+"-"+rs.getInt("codigo_emp")+".json"),StandardCharsets.UTF_8));
    ...
    public void writeDataPartnerJson(int codigoSocio){
        try{
            ...
            rs=ps.executeQuery();
            while(rs.next()){
                new File(System.getProperty("user.dir")+"/src/main/resources/data/databackup/Socios/"+rs.getString("nombre_part")+"-"+rs.getInt("codigo_part")).mkdir();
                jsonw=new JsonWriter(new OutputStreamWriter(new FileOutputStream(System.getProperty("user.dir")+"/src/main/resources/data/databackup/Socios/"+rs.getString("nombre_part")+"-"+rs.getInt("codigo_part")+"/"+rs.getString("nombre_part")+"-"+rs.getInt("codigo_part")+".json"),StandardCharsets.UTF_8));
            ...
            JOptionPane.showMessageDialog(null,"Error:\n"+n.getMessage(),"Error 14",JOptionPane.WARNING_MESSAGE);
            new logger().staticLogger("Error 14: "+n.getMessage()+".\nOcurrió en la clase '"+escritorJSON.class.getName()+"', en el método 'writeDataPartnerJson()'",Level.WARNING);
            new logger().exceptionLogger(escritorJSON.class.getName(),Level.WARNING,"writeDataPartnerJson-14",n.fillInStackTrace());
        }
    }
    ...
    public void writeDataProviderJson(int codigoProveedor){
        try{
            ...
            rs=ps.executeQuery();
            while(rs.next()){
                new File(System.getProperty("user.dir")+"/src/main/resources/data/databackup/Proveedores/"+rs.getString("nombre_prov")+"-"+rs.getInt("codigo_prov")).mkdir();
                jsonw=new JsonWriter(new OutputStreamWriter(new FileOutputStream(System.getProperty("user.dir")+"/src/main/resources/data/databackup/Proveedores/"+rs.getString("nombre_prov")+"-"+rs.getInt("codigo_prov")+"/"+rs.getString("nombre_prov")+"-"+rs.getInt("codigo_prov")+".json"),StandardCharsets.UTF_8));
            ...
            JOptionPane.showMessageDialog(null,"Error:\n"+n.getMessage(),"Error 14",JOptionPane.WARNING_MESSAGE);
            new logger().staticLogger("Error 14: "+n.getMessage()+".\nOcurrió en la clase '"+escritorJSON.class.getName()+"', en el método 'writeDataProviderJson()'",Level.WARNING);
            new logger().exceptionLogger(escritorJSON.class.getName(),Level.WARNING,"writeDataProviderJson-14",n.fillInStackTrace());
        }
    }
}