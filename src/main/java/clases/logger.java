...
public class logger{
    ...
    static{
        try{
            ...
            new logger(Level.SEVERE,CLASSNAME).storeAndViewCaughtException(frames,e,"Internal","SE");
        }catch(IOException x){
            new logger(Level.SEVERE,CLASSNAME).storeAndViewCaughtException(frames,x,"Internal","1IO");
        }
    }
    ...
    public static void staticLogger(Level level,String message,String className1){
        ...
        try{
            ...
            new logger(Level.SEVERE,CLASSNAME).storeAndViewCaughtException(frames,e,"staticLogger","SE");
        }
    }
    ...
    public void exceptionLogger(String methodName1,Throwable ex){
        ...
        try{
            ...
            new logger(Level.SEVERE,CLASSNAME).storeAndViewCaughtException(frames,e,methodName0,"SE");
        }catch(IOException x){
            new logger(Level.SEVERE,CLASSNAME).storeAndViewCaughtException(frames,x,methodName0,"1IO");
        }
    }
     ...
     */
    public void storeAndViewCaughtException(Component comp,Throwable ex,String methodName1,String level1){
    ...
    public void storeAndViewNumberInputWarning(Component comp,String methodName1){
    ...
    public void storeAndViewLetterInputWarning(Component comp,String methodName1){
    ...
    public void storeAndViewError14(Component comp,String methodName1){
    ...
    public void storeAndViewError18(Component comp,String methodName1){
