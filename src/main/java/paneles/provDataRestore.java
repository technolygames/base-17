...
public class provDataRestore extends javax.swing.JPanel{
    ...
    public provDataRestore(Controlador modelo){
        initComponents();
    ...
    protected final void botones(){
        ...
        loadDataButton.addActionListener(a->{
            try{
                new Datos(modelo).insertarDatosProveedor(new LectorJson().readDataProviderJson(jTextField1.getText()));
            }catch(SQLException s){
                new logger(Level.SEVERE,this.getClass().getName()).catchException(this,s,"botones.loadData","11");
            }
        });
    }
