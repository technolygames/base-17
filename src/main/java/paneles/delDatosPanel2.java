...
public class delDatosPanel2 extends javax.swing.JPanel{
        ...
        try{
            if(!jTextField1.getText().isEmpty()){
                ...
                switch(JOptionPane.showConfirmDialog(this,"¿Deseas crear una copia de seguridad?","Notice 1",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE)){
                    case 0:{
                        new EscritorJson1().writeDataPartnerJson(codigo);
                ...
                new logger(Level.WARNING).storeAndViewError18(this,delDatosPanel2.class.getName(),methodName);
            }
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        if(Character.isLetter(evt.getKeyChar())){
            new logger(Level.WARNING).storeAndViewLetterInputWarning(this,delDatosPanel2.class.getName(),"jTextField1KeyPressed");
            evt.consume();
        }
