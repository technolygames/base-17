    ...
    protected void datosBuscar(){
        try{
            ...
            if(rs.next()){
                ...
                new logger(Level.WARNING).staticLogger("Error 14: no hay datos que concuerden con los datos escritos.\nOcurrió en la clase '"+modPicPanel1.class.getName()+"', en el método 'datosMostrar()'");
            }
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null,"Error:\n"+e.getMessage(),"Error 14",JOptionPane.ERROR_MESSAGE);
            new logger(Level.SEVERE).staticLogger("Error 14: "+e.getMessage()+".\nOcurrió en la clase '"+modPicPanel1.class.getName()+"', en el método 'datosMostrar()'");
            new logger(Level.SEVERE).exceptionLogger(modPicPanel1.class.getName(),"datosMostrar-14",e.fillInStackTrace());
        }
    }
