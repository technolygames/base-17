...
public class delDatosPanel3 extends javax.swing.JPanel{
    ...
    public delDatosPanel3(Controlador modelo){
        initComponents();
    ...
    public delDatosPanel3(int code,Controlador modelo){
        initComponents();
    ...
    public delDatosPanel3(int code,boolean flag,Controlador modelo){
        initComponents();
        ...
        try{
            if(!jTextField1.getText().isEmpty()){
                ...
                switch(JOptionPane.showConfirmDialog(this,"¿Deseas crear una copia de seguridad?","Notice 1",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE)){
                    case 0:{
                        new EscritorJson(modelo).writeDataProviderJson(codigo);
