...
public class delDatosPanel3 extends javax.swing.JPanel{
    public delDatosPanel3(){
        initComponents();
        new laf(delDatosPanel3.class.getName()).LookAndFeel(delDatosPanel3.this);
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        if(Character.isLetter(evt.getKeyChar())){
            ...
            new logger().staticLogger("Let 6: se ingresaron letras en un campo equivocado.\nOcurrió en la clase '"+delDatosPanel3.class.getName()+"', en el método 'jTextField1KeyPressed()'",Level.WARNING);
            evt.consume();
        }
